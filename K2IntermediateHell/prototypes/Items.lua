...
item.greenSci2 = NewScience("green-sci-2", MomoLib.AltCard("logistic-science-pack"), 100)
...
item.blueSci2 = NewScience("blue-sci-2", MomoLib.AltCard("chemical-science-pack"), 20)

item.inconShape = NewScience("incontinue-shape", {MomoLib.icon.Get("incontinue-shape.png"), 32}, 100)

item.purpleSci1 = NewScience("purple-sci-1", MomoLib.icon.FromIngredientWithSize(item.purpleSci), 20)
item.purpleSci2 = NewScience("purple-sci-2", MomoLib.AltCard("production-science-pack"), 100)
item.purpleSci3 = NewScience("purple-sci-3", {MomoLib.icon.Get("purple-sci-3.png"), 32}, 100)

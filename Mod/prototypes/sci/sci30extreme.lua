...
if data.raw["tool"]["more-science-pack-1"] and 
  settings.startup["momo-30-sci-extreme"].value and 
  settings.startup["momo-fix-angels-chemistry-machine"].value and
  data.raw.technology["angels-advanced-chemistry-4"] then
  ...
  if mods["omnilib"] then unlock_tech = "circuit-network" end
  ...
  if mods["omnilib"] then unlock_tech = "electric-energy-distribution-2" end
  ...
  if mods["omnilib"] then unlock_tech = "effect-transmission" end
  ...
  if mods["omnilib"] then unlock_tech = "atomic-bomb" end

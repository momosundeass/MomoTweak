...
item.ironEnriched   = itemName:New("kr-enriched-iron")
item.copperPlate    = itemName:New("copper-plate")
item.copperMolten   = itemName:New("molten-copper")
item.copperEnriched = itemName:New("kr-enriched-copper")
item.cable          = itemName:New("copper-cable")
item.copperDust     = itemName:New("copper-dust")
...
item.rareMetalEnriched= itemName:New("kr-enriched-rare-metals")
...
item.rareMetalDust  = itemName:New("rare-metals-dust")
...
item.titaniumEnriched= itemName:New("enriched-titanium", "enriched-titanium")
item.titaniumDust   = itemName:New("titanium-dust", "titanium-processing")
...
item.eqBigSolar2   = itemName:New("kr-big-superior-solar-panel-equipment", "kr-superior-solar-panel-equipment")
...
item.laserTurret   = itemName:New("laser-turret", "laser-turret")
item.laserTurret   = itemName:New("laser-turret", "laser-turret")
item.laserArtillery= itemName:New("kr-laser-artillery-turret", "kr-laser-artillery-turret")
...
item.heavyOil      = itemName:New("heavy-oil", "advanced-oil-processing")
item.lightOil      = itemName:New("light-oil", "advanced-oil-processing")

-- Copy from space age dlc with some modification
...
local function bmd_sprite_load(file_name, table)
  ...
  table.priority = "high"
  table.scale = 0.5
  table.filename = MomoLib.Graphics("space-age/big-mining-drill/") .. direction_long .. "big-mining-drill-" .. file_name
...
local ref = data.raw["mining-drill"][MomoLib.itemNames.miningDrill.n]
data:extend({
  {
    type = "mining-drill",
    name = "big-mining-drill",
    icon = MomoLib.Graphics("space-age/big-mining-drill.png"),
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 0.3, result = "big-mining-drill"},
    max_health = 300,
    resource_categories = ref.resource_categories,
    corpse = "big-mining-drill-remnants",
    dying_explosion = ref.dying_explosion,
    ...
    {
      filename = MomoLib.Graphics("space-age/big-mining-drill/big-mining-drill-radius-visualization.png"),
      width = 10,
      height = 10
    },
    ...
    resource_drain_rate_percent = 70,
    module_slots = 2,
  ...
  },
  {
    ...
    animation = make_rotated_animation_variations_from_sheet(4, util.sprite_load(MomoLib.Graphics("space-age/big-mining-drill/remnants/big-mining-drill-remnants"),
      {
        scale = 0.5,
        direction_count = 1
      })
...
MomoLib.machine.CopySounds(MomoLib.itemNames.miningDrill.n, "big-mining-drill")
MomoLib.machine.Power("big-mining-drill", "300kW")

local item = MomoLib.item.Create("big-mining-drill", MomoLib.Graphics("space-age/big-mining-drill.png", 64), 50)
---@type ItemName
MomoLib.itemNames.bigMiningDrill = MomoLib.itemName:New(item)
item.place_result = "big-mining-drill"
item:SUBGROUP("extraction-machine", "a[items]-d[big-mining-drill]")

---@type Technology
local tech = MomoLib.technology.Clone(MomoLib.itemNames.miningDrill2.tech, "big-mining-drill")
tech:PRE{
    MomoLib.itemNames.miningDrill2.tech, 
    MomoLib.itemNames.electricEngine.tech, 
    MomoLib.itemNames.titaniumPlate.tech, 
  }:ICON(MomoLib.Graphics("big-mining-drill.png", 256)):EFFECTS()

  tech:Extend()
MomoLib.itemNames.bigMiningDrill.tech = tech.name

local recipe = MomoLib.recipe.New({
  MomoLib.itemNames.miningDrill2:I(2),
  MomoLib.itemNames.jawCrusher:I(40),
  MomoLib.itemNames.electricEngine:I(60),
  MomoLib.itemNames.strongBox:I(),
  MomoLib.itemNames.titaniumPlate:I(60),
  MomoLib.itemNames.bulkInserter:I(24),
}, {
  MomoLib.itemNames.bigMiningDrill:I()
}):UNLOCK("big-mining-drill"):TIME(30):Extend()
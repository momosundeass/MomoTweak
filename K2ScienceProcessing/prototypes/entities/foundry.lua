...
MomoLib.GetRecipe(Item.inserterPart.n,           function(p) p:ADDCATEGORY{"metallurgy"} end)
...
MomoLib.GetRecipe(Item.bulkInserter.n,           function(p) p:ADDCATEGORY{"metallurgy"} end)
MomoLib.GetRecipe(Item.stackInserter.n,          function(p) p:ADDCATEGORY{"metallurgy"} end)
...
MomoLib.technology.AddRequired(Item.advancedBelt.tech, Item.foundry.tech)

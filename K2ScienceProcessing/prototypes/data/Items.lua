...
MomoLib.itemNames.rcu = MomoLib.NewIntermediate("rocket-control-unit", MomoLib.SpaceEx("rocket-control-unit"), 100)
MomoLib.itemNames.rocketSection = MomoLib.NewIntermediate("rocket-section", MomoLib.SpaceEx("cargo-rocket-section"), 100)
...
MomoLib.itemNames.blueSci2 = NewScience("blue-sci-2", MomoLib.AltCard("chemical-science-pack"), 200, sb.blueSci.name)
...
MomoLib.itemNames.purpleSci2 = NewScience("purple-sci-2", MomoLib.AltCard("production-science-pack"), 200, sb.purpleSci.name)
...
MomoLib.itemNames.matterSci2 = NewScience("matter-sci-2", MomoLib.AltCard("kr-matter-tech-card"), 100, sb.matterSci.name)

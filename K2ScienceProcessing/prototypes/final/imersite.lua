...
MomoLib.technology.AddRequired(Item.quarry.tech, {Item.rareMetalClump.tech, Item.assembly3.tech, Item.bigMiningDrill.tech })
MomoLib.recipe.SetIngredients(Item.quarry, {
    ...
    Item.blueChip:I(40),
    Item.bigMiningDrill:I()
})
MomoLib.machine.ModuleSlot(Item.quarry.n, 4)

...
function momoIRTweak.updates.Electronics()
	if (momoIRTweak.electronics.isHarder) then
		...
		-- balanced k computer recipe
		AddIng("computer-mk1-2", ITEM("controller-mk1", 2))
		momoIRTweak.recipe.SaveAddIngredient("computer-mk1-2", ITEM("k-ram", 16))		
		momoIRTweak.recipe.SaveAddIngredient("computer-mk1-2", ITEM("k-processor", 8))
		
		AddIng("computer-mk2-2", ITEM("controller-mk2", 3))
		momoIRTweak.recipe.SaveAddIngredient("computer-mk2-2", ITEM("k-ram", 32))		
		momoIRTweak.recipe.SaveAddIngredient("computer-mk2-2", ITEM("k-processor", 16))
		
		AddIng("computer-mk3-2", ITEM("controller-mk3", 4))
		momoIRTweak.recipe.SaveAddIngredient("computer-mk3-2", ITEM("k-ram", 64))		
		momoIRTweak.recipe.SaveAddIngredient("computer-mk3-2", ITEM("k-processor", 24))
		
		AddIng("k-processor", ITEM("steel-rivet", 3))

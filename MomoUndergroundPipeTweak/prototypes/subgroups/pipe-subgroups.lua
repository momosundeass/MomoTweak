local MergeSubgroup = momoIRTweak.subgroup.MergeRecipeItemSubgroup
...
function momoPipeTweak.subgroups.Update()
	...
	MergeSubgroup(undergroundBuildings, "underground-buildings")
	local ptgs1 = {
	...
	MergeSubgroup(ptgs1, "pipes-to-ground")
	...
	MergeSubgroup(ptgs2, "pipes-to-ground-t2")
	...
	MergeSubgroup(ptgs3, "pipes-to-ground-t3")
	...
	if momoPipeTweak.mods.SpaceEx then
		...
		MergeSubgroup(ptgs4, "pipes-to-ground-t4")
	end
